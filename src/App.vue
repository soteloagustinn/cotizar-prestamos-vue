...
<template >
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="flex justify-between mt-10">
      ...
      <Button
        :operador="'-'"
        @fn = "handeleChangeDecremento"
      />

      <Button
        :operador="'+'"
        @fn="handeleChangeIncremento"
      /> 
    </div>
    ...
    />
      ...
      <select class="w-full p-2 bg-white border border-gray-300 rounded-lg text-center text-xl font-bold text-gray-500 mt-5" value="meses" v-model.number="meses">
    ...
    <div  v-if="total>0" class="my-5 space-y-3 bg-gray-50 p-5">
      <h2 class="text-2xl  text-gray-500  font-extrabold text-center">
